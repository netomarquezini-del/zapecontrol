...
export default function CsComunidadePage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      const res = await fetch(
        `/api/cs/community?from=${periodFrom.toISOString()}&to=${periodTo.toISOString()}`
      )
    ...
    <div className="space-y-8">
      ...
      {loading ? (
        ...
        <>
          ...
          {/* ─── 4. Horários de Pico + Dia da Semana ─── */}
