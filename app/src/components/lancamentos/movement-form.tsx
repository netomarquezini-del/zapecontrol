...
export default function MovementForm({
  ...
  const inputClass =
    "w-full rounded-lg border border-[#222222] bg-[#111111] px-3 py-2 text-sm text-white placeholder-zinc-500 focus:border-lime-400/30 focus:outline-none";
  const selectClass =
    "w-full rounded-lg border border-[#222222] bg-[#111111] px-3 py-2 text-sm text-white focus:border-lime-400/30 focus:outline-none";
  const labelClass = "block text-xs font-medium text-zinc-400 mb-1";

  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-black/60 p-4 pt-10">
      <div className="w-full max-w-4xl rounded-2xl border border-[#222222] bg-[#0a0a0a] shadow-2xl">
        {/* Header */}
        ...
        <div className="space-y-6 p-6">
          ...
          <div>
            ...
            <div className="overflow-x-auto rounded-lg border border-[#222222]">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {sdrs.map((sdr) => (
                    <tr key={sdr.id} className="border-b border-[#222222] last:border-0">
                        ...
                        (field) => (
                          <td key={field} className="px-3 py-2">
                            <input
                              type="number"
                              min={0}
                              className="w-20 mx-auto block rounded-md border border-[#222222] bg-[#111111] px-2 py-1.5 text-center text-sm text-white focus:border-lime-400/30 focus:outline-none"
          ...
          <div className="flex items-center justify-end gap-3 border-t border-[#222222] pt-4">
            <button
              type="button"
              onClick={onClose}
              className="rounded-lg border border-[#222222] px-4 py-2 text-sm font-medium text-zinc-300 hover:bg-white/5 transition-colors"
            >
              Cancelar
            </button>
            <button
